...
public:
    ...
    void drawGhost(uint16_t x, uint16_t y, uint16_t width, uint16_t height, cColor bodyColor, cColor eyeColor);
    void drawExplosion(uint16_t x, uint16_t y, uint16_t size, cColor mainColor, cColor secondaryColor);
